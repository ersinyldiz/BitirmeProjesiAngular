...
export class YardimSeverIslemleriService {
  ...
  public AddKullaniciBilgileri(data: KullaniciBilgileri) {
    return this.httpclient.post<SonucBildirimi>(this.apiUrl + 'AddKullaniciBilgileri', data).pipe(tap(x => {
      this.loading = true;
    }));
  }

  public UpdateKullaniciBilgileri(data: KullaniciBilgileri) {
    return this.httpclient.put<SonucBildirimi>(this.apiUrl + 'UpdateKullaniciBilgileri', data).pipe(tap(x => {
      this.loading = true;
    }));
  }
